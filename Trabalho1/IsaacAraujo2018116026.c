...
//  ----- Dados do Aluno -----
//  Nome: Isaac Viana da Cunha Araújo
//  email: isaaccunhasj@hotmail.com
//  Matrícula: 2018116026
//  Semestre: 2
                    ...
                    nAnos = iAnofinal - iAnoinicial;
                        ...
                        nAnos = iAnofinal - iAnoinicial;
                            ...
                            nAnos = iAnofinal - iAnoinicial;
                             ...
                             else if((iAnofinal > iAnoinicial) && (anobissoextoinicial == 1) && (iMesfinal == iMesinicial) && (iDiainicial == 29 && iDiafinal == 28)){
                                nDias = 0;
                                nMeses = 0; 
                                nAnos = 1;
                             }
